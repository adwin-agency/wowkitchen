...
const points = {
  minimal: {
    straight: [
      { title: 'Качественное МДФ, которому не страшны перепад темеператур', coords: [49, 63] },
    ...
    straightisland: [
      ...
      { title: 'Качественное МДФ, которому не страшны перепад темеператур', coords: [52, 62] },
      { title: 'Встроенная в шкаф-пенал духовка', coords: [77, 53] }
    ],
    corner: [
