    ...
    return {
      items: [
        ...
        },
        {
          ...
          requirements: ['опыт работы от 1 года', 'уверенное владение ПК', 'грамотная речь, чёткая дикция', 'высокие коммуникативные навыки'],
          offer: [
            'интересная работа в престижной, стабильной компании',
            'официальное трудоустройство по ТК РФ',
            'работа в комфортном офисе в шаговой доступности от м. Электросила',
            'скидки на продукцию компании',
            'заработная плата от 80 000 рублей'
          ]
        },
        {
          ...
          requirements: ['опыт работы от 1 года', 'ответственность, пунктуальность, неконфликтность'],
          offer: [
            'интересная работа в престижной, стабильной компании',
            'официальное трудоустройство по ТК РФ',
